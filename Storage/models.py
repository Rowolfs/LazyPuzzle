...
class VerbalRiddles(BasicSettings):
    ...
    themes = models.ManyToManyField(
        Themes, blank=True, through='ThemesToVerbalRiddles', null=True)
...
class ThemesToVerbalRiddles(models.Model):
    class Meta():
        db_table = "db_bP_themes_to_vr"
    vr = models.ForeignKey(VerbalRiddles, on_delete=models.CASCADE, null=True)
    themes = models.ForeignKey(Themes, on_delete=models.CASCADE, null=True)